<template>
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    ...
    <div
      id="profile"
      class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl opacity-75 mx-6 lg:mx-0 bg-indigo-600"
    >
      <div class="p-4 md:p-12 text-center lg:text-left">
        ...
        >
          <a class="link" href="#" data-tippy-content="@facebook_handle">
            <svg
              class="h-6 fill-current text-white hover:text-teal-700"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
